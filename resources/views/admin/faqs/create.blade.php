...
@section('page_header', 'Create Frequently Asked Question')
...
<div class="container-fluid p-0 overflow-hidden" style="max-width: 800px;">
    ...
    <div class="card border-0 p-4 shadow-lg">
        <div class="card-header bg-transparent border-0 p-0 mb-4">
            <span class="fs-5 fw-extrabold text-white">New FAQ Details</span>
            <p class="small text-secondary mb-0">Fill out the question, answer explanation, and display sequence priority.</p>
        </div>
